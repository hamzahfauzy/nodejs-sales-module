...
export default {
  ...
  path: "sales/subscription-bills",
  permission: "trx_invoices.list",

  content: {
    type: "crud",
    value: {
      endpoint: "/table/trx_invoices?filters[record_type]=SUBSCRIPTION",
      create: {
        label: "Create",
        icon: "plus",
        endpoint: '/app/sales/create-subscription-invoice',
      ...
      actions: [
        {
          ...
          title: "Subscription Bill Detail",
          modalClass: "modal-lg",
          fields: [
            {
